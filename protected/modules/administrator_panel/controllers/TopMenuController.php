...
class TopMenuController extends Controller
{
	...
	{
		/*
		$dataProvider=new CActiveDataProvider('TopMenu');
	...
	{
		$model=TopMenu::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='top-menu-form')
		{
	...
	function actionAutocomplete()
	{
		...
		if (isset($_GET['term']))
		{
			...
			$models = TopMenu::model()->findAll($crit);
