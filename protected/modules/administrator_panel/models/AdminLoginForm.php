 ...
 * user login form data. It is used by the 'login' action of 'DefaultController' in 'admin' module.
 */
class AdminLoginForm extends CFormModel
{
	...
	public function login()
	{
		...
		if($this->_identity->errorCode===AdminUserIdentity::ERROR_NONE)
		{
			...
			Yii::app()->getModule('administrator_panel')->user->login($this->_identity,$duration);
			return true;
		}
		else
			return false;
