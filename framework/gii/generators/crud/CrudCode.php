...
class CrudCode extends CCodeModel
{
	...
	public function generateActiveLabel($modelClass,$column)
	{
		if(stripos($column->dbType,'text')!==false)
			return "\$form->labelEx(\$model,'{$column->name}', array('class'=>'control-label', 'for'=>'textarea2'))";
		else
	...
	public function generateActiveField($modelClass,$column)
	{
		...
		elseif(stripos($column->dbType,'text')!==false)
			return "\$form->textArea(\$model,'{$column->name}',array('class'=>'input-xlarge textarea', 'style'=>'width: 710px; height: 200px'))";
		else
		{
			if(preg_match('/^(password|pass|passwd|passcode)$/i',$column->name))
